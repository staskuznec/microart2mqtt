...
const (
	...
	// checkInterval — как часто спрашиваем сами, в фоне. Раз в сутки было
	// слишком редко: человек заходит на страницу и видит вчерашний ответ, хотя
	// релиз уже вышел. Шесть часов и предел обращений к API не трогают, и
	// новость не залёживается — а при заходе на страницу результат всё равно
	// освежается (EnsureFresh).
